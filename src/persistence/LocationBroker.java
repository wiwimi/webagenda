...
public class LocationBroker extends Broker<Location>
     ...
     */
    @Override
    public boolean create(Location createLocation, Employee caller) throws DBException,
     ...
     */
    @Override
    public boolean delete(Location deleteLocation, Employee caller) throws DBChangeException,
        ...
        try
            ...
            if (result != 1)
                throw new DBChangeException(
                        "Location not found, may have been changed or deleted by another user.");
            }
        catch (SQLException e)
            {
     ...
     */
    @Override
    public Location[] get(Location searchTemplate, Employee caller) throws DBException,
     ...
     */
    @Override
    public boolean update(Location oldLocation, Location updateLocation, Employee caller)
            throws DBChangeException, DBException, DBDownException, InvalidPermissionException,
        ...
        String update = String
                .format(
                        ...
                        (updateLocation.getDesc() == null ? "NULL" : "'" +
                                updateLocation.getDesc() + "'"),
                        oldLocation.getName(),
