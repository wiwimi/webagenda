...
public class Position extends BusinessObject
    ...
    /**
     * Constructor that takes a name for the position as well as a list of
     * skills as a Skill array
     * 
     * @param pos_name String
     * @param skills Skill[]
     */
    ...
    /**
     * Constructor that takes a Position name and description as well as a list
     * of skills for that position.
     * 
     * @param pos_name String
