...
/**
 * A notification is a type of message object that is sent to employees. These
 * can be sent out automatically to inform an employee of the status of requests
 * they have made, or changes to their schedules, and can also be sent manually
 * if a supervisor wishes to send a message to his/her employees.
 * 
 * @author dann
 * @version 0.01.00
 * @license GPL 2
...
public class Notification extends BusinessObject
    ...
    /**
     * Constructor with required parameters as well as a Timestamp attribute
     * that determines when message was sent. If you want a notification to
     * appear in the future, this constructor should be used.
     * 
     * @param notificationID id of this notification. Should be auto-set by
     *            database so any value can be used
    ...
    /*
     * Actual message will not be shown to protect privacy (non-Javadoc)
     * @see java.lang.Object#toString()
     */
    @Override
    public String toString()
        {
        return notificationID + ";" + senderID + ";" + recipientID + ";" + sentTime + ";" + viewed +
                ";" + type;
        }
