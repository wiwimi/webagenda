			 ...
			 <div id="personal">
				 ...
				 <fieldset>
					<legend > Personal </legend>
							...
							<p>	<label id="theSelect" class="theSelect" > First Name: <em class="asterisk"> * </em> </label> <input type="text"  value="" name ="givenName" size ="30"> </p>
							<p>	<label id="theSelect" class="theSelect" > Last Name: <em class="asterisk"> * </em> </label> <input type="text"  value="" name ="familyName" size ="30"> </p>
							<p>	<label id="theSelect" class="theSelect" > Date of Birth: <em class="asterisk"> * </em> </label> <input type="text" name ="dob" value="" id="dob" size ="10"></p>

					       <div id="email">
								<label id="theSelect" class="theSelect"  for="email"> E-mail: <em class="asterisk"> * </em> </label> 
							    <input name="confirmEmail" value="" id="confirmpass" type="text" size ="30" maxlength="30" />
						   </div>
			...
			<fieldset>
				<legend> Working Preferences </legend>
					...
					<p>		
							...
							<input id="prefPositionBox" type="text" size="30" maxlength="30" disabled="disabled" value="" name="prefPositionBox" />
							<button type="submit" value="edit">edit</button>
					...
					<p>		
							...
							<input id="prefLocationBox" type="text" size="30" value="" disabled="disabled" maxlength="30" value="" name="prefLocationBox" />
							<button type="submit" value="edit">edit</button>
					</p>	
